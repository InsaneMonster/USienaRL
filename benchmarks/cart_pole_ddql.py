...
def _define_ddqn_model(config: Config) -> DoubleDeepQLearning:
    # Define attributes
    ...
    # Return the _model
    return DoubleDeepQLearning("model",
...
if __name__ == "__main__":
    ...
    # Define agents
    ddqn_epsilon_greedy_agent: DoubleDeepQLearningAgent = _define_epsilon_greedy_agent(inner_model, epsilon_greedy_exploration_policy)
    ddqn_boltzmann_agent: DoubleDeepQLearningAgent = _define_boltzmann_agent(inner_model, boltzmann_exploration_policy)
    # Define experiments
    experiment_egreedy: BenchmarkExperiment = BenchmarkExperiment("eg_experiment", success_threshold, environment,
                                                                  ddqn_epsilon_greedy_agent)
    experiment_boltzmann: BenchmarkExperiment = BenchmarkExperiment("b_experiment", success_threshold, environment,
                                                                    ddqn_boltzmann_agent)
