...
def _define_epsilon_greedy_agent(model: TabularExpectedSARSA) -> TabularExpectedSARSAAgentEpsilonGreedy:
    ...
    # Return the agent
    return TabularExpectedSARSAAgentEpsilonGreedy("tesarsa_agent", model, summary_save_step_interval, batch_size,
...
def _define_boltzmann_agent(model: TabularExpectedSARSA) -> TabularExpectedSARSAAgentBoltzmann:
    ...
    # Return the agent
    return TabularExpectedSARSAAgentBoltzmann("tesarsa_agent", model, summary_save_step_interval, batch_size,
...
def _define_dirichlet_agent(model: TabularExpectedSARSA) -> TabularExpectedSARSAAgentDirichlet:
    ...
    # Return the agent
    return TabularExpectedSARSAAgentDirichlet("tesarsa_agent", model, summary_save_step_interval, batch_size,
