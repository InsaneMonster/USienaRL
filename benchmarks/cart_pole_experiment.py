...
def _define_epsilon_greedy_explorer() -> EpsilonGreedyExplorationPolicy:
    ...
    exploration_rate_end_value: float = 0.001
...
if __name__ == "__main__":
    ...
    q_learning_experiments_data: [] = [(model_dqn, "_er_eg", experience_replay, 50, epsilon_greedy_explorer),
                                       (model_ddqn, "_per_b", prioritized_experience_replay, 50, boltzmann_explorer),
                                       (model_dddqn, "_per_b", prioritized_experience_replay, 50, boltzmann_explorer)]
