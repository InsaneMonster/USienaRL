...
def run(workspace: str,
    ...
    #       - general success threshold to consider the training and the experiment successful is 200.0 over 100 episodes according to OpenAI guidelines
