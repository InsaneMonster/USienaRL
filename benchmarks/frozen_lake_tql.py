...
def _define_epsilon_greedy_agent(model: TabularQLearning) -> TabularQLearningAgentEpsilonGreedy:
    ...
    # Return the agent
    return TabularQLearningAgentEpsilonGreedy("tql_agent", model, summary_save_step_interval, batch_size,
...
def _define_boltzmann_agent(model: TabularQLearning) -> TabularQLearningAgentBoltzmann:
    ...
    # Return the agent
    return TabularQLearningAgentBoltzmann("tql_agent", model, summary_save_step_interval, batch_size,
...
def _define_dirichlet_agent(model: TabularQLearning) -> TabularQLearningAgentDirichlet:
    ...
    # Return the agent
    return TabularQLearningAgentDirichlet("tql_agent", model, summary_save_step_interval, batch_size,
