...
def _define_epsilon_greedy_agent(model: DoubleDeepQLearning) -> DoubleDeepQLearningAgentEpsilonGreedy:
    ...
    # Return the agent
    return DoubleDeepQLearningAgentEpsilonGreedy("ddqn_agent", model, summary_save_step_interval, weight_copy_step_interval, batch_size,
...
def _define_boltzmann_agent(model: DoubleDeepQLearning) -> DoubleDeepQLearningAgentBoltzmann:
    ...
    # Return the agent
    return DoubleDeepQLearningAgentBoltzmann("ddqn_agent", model, summary_save_step_interval, weight_copy_step_interval, batch_size,
...
def _define_dirichlet_agent(model: DoubleDeepQLearning) -> DoubleDeepQLearningAgentDirichlet:
    ...
    # Return the agent
    return DoubleDeepQLearningAgentDirichlet("ddqn_agent", model, summary_save_step_interval, weight_copy_step_interval, batch_size,
...
def run(workspace: str,
    ...
    experiment_epsilon_greedy_refactored: BenchmarkExperiment = BenchmarkExperiment("experiment_refactored_epsilon_greedy", success_threshold_refactored,
                                                                                    ...
                                                                                    ddqn_agent_epsilon_greedy)
    experiment_boltzmann_refactored: BenchmarkExperiment = BenchmarkExperiment("experiment_refactored_boltzmann",
                                                                               success_threshold_refactored,
                                                                               environment_refactored,
                                                                               ddqn_agent_boltzmann)
    experiment_dirichlet_refactored: BenchmarkExperiment = BenchmarkExperiment("experiment_refactored_dirichlet",
                                                                               success_threshold_refactored,
                                                                               environment_refactored,
                                                                               ddqn_agent_dirichlet)
