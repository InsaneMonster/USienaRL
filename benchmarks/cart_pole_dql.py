...
if __name__ == "__main__":
    ...
    # Define agents
    dqn_epsilon_greedy_agent: DeepQLearningAgent = _define_epsilon_greedy_agent(inner_model, epsilon_greedy_exploration_policy)
    dqn_boltzmann_agent: DeepQLearningAgent = _define_boltzmann_agent(inner_model, boltzmann_exploration_policy)
    # Define experiments
    experiment_egreedy: BenchmarkExperiment = BenchmarkExperiment("eg_experiment", success_threshold, environment,
                                                                  dqn_epsilon_greedy_agent)
