...
def _define_epsilon_greedy_agent(model: DeepQLearning) -> DeepQLearningAgentEpsilonGreedy:
    ...
    # Return the agent
    return DeepQLearningAgentEpsilonGreedy("dqn_agent", model, weight_copy_step_interval, summary_save_step_interval, batch_size,
...
def _define_boltzmann_agent(model: DeepQLearning) -> DeepQLearningAgentBoltzmann:
    ...
    # Return the agent
    return DeepQLearningAgentBoltzmann("dqn_agent", model, summary_save_every_steps, weight_copy_every_steps, batch_size,
