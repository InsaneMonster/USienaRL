...
def _define_epsilon_greedy_agent(model: TabularSARSA) -> TabularSARSAAgentEpsilonGreedy:
    ...
    # Return the agent
    return TabularSARSAAgentEpsilonGreedy("tsarsa_agent", model, batch_size,
...
def _define_boltzmann_agent(model: TabularSARSA) -> TabularSARSAAgentBoltzmann:
    ...
    # Return the agent
    return TabularSARSAAgentBoltzmann("tsarsa_agent", model, batch_size,
...
def _define_dirichlet_agent(model: TabularSARSA) -> TabularSARSAAgentDirichlet:
    ...
    # Return the agent
    return TabularSARSAAgentDirichlet("tsarsa_agent", model,  batch_size,
