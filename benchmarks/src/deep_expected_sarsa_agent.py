...
class DeepExpectedSARSAAgent(Agent):
    """
    Deep Expected SARSA agent.

    It is supplied with a Deep Expected SARSA model and an exploration policy.
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(DeepExpectedSARSAAgent, self).__init__(name)
