...
class Experiment:
    ...
    def test(self,
        ...
        with tensorflow.Session(config=self._tensorflow_config) as session:
            ...
            logger.info("Average test total reward: ")
            logger.info("Average test scaled reward: ")
            ...
            logger.info("Average test standard deviation of total reward: ")
            logger.info("Average test standard deviation of scaled reward: ")
