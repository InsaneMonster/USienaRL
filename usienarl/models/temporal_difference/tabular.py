...
# Define update rules for the _model
...
class Tabular(Model):
    ...
    def __init__(self,
        ...
        # Define tabular _model attributes
        self.learning_rate: float = learning_rate
        self.discount_factor: float = discount_factor
        # Define internal tabular _model attributes
        ...
        self._importance_sampling_value_increment: float = importance_sampling_value_increment
        # Define tabular _model empty attributes
        self.buffer: Buffer = None
        # Define internal tabular _model empty attributes
        self._table = None
    ...
    def update(self,
        ...
        # Get the q-values from the _model at both current observations and next observations
        ...
        # Train the _model and save the value of the loss and of the absolute error as well as the _summary
